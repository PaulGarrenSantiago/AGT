...
<body>
  <div class="container">
    ...
    <div class="grid">
      <div class="card" onclick="window.location.href='category-view.php?cat=business'">
        <img src="img/business.png" alt="Business" class="podcast-cover" />
      </div>
      <div class="card" onclick="window.location.href='category-view.php?cat=health'">
        <img src="img/health.png" alt="Health & Wellness" class="podcast-cover" />
      </div>
      <div class="card" onclick="window.location.href='category-view.php?cat=technology'">
        <img src="img/technology.jpg" alt="Technology" class="podcast-cover" />
      </div>
      <div class="card" onclick="window.location.href='category-view.php?cat=lifestyle'">
    ...
    <div class="grid">
      <div class="card" onclick="window.location.href='category-view.php?cat=education'">
        <img src="img/education.png" alt="Education" class="podcast-cover" />
      </div>
      <div class="card" onclick="window.location.href='category-view.php?cat=sports'">
        <img src="img/sports.jpg" alt="Sports" class="podcast-cover" />
      </div>
      <div class="card" onclick="window.location.href='category-view.php?cat=comedy'">
        <img src="img/comedy.jpg" alt="Comedy" class="podcast-cover" />
      </div>
      <div class="card" onclick="window.location.href='category-view.php?cat=music'">
